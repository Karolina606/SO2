...
find linux-5.11.13/ -name mips -prune -o -type f \
    '(' '(' -name "core.c" -o -name "irq.c" ')' -size -1024c -print ')' \
         -o \
    '(' '(' -name "core.c" -o -name "irq.c" ')' -path "*/bluetooth/*" -size +30720c -print ')' ;


############# ROZDZIELNOE DLA CZYTELNOŚCI #############
# find linux-5.11.13/ -name mips -prune -o -type f \( -name "irq.c" -size -1024c -print \) -o \( -name "irq.c" -path "*/bluetooth/*" -size +30720c -print \);
# find linux-5.11.13/ -name mips -prune -o -type f \( -name "core.c" -size -1024c -print \) -o \( -name "core.c" -path "*/bluetooth/*" -size +30720c -print \);